...
cd e_comerce_backend_laravel</pre>
                        ...
                        <h4>4. Setup Environment</h4>
                        <div class="code-box">
                            <pre>cp .env.example .env
php artisan key:generate</pre>
                        </div>

                        <h4>5. Configure Database</h4>
                        <p>Edit <code>.env</code> file with database credentials:</p>
                        <div class="code-box">
                            <pre>DB_CONNECTION=mysql
DB_HOST=127.0.0.1
...
DB_PASSWORD=</pre>
                        ...
                        <h4>6. Run Migrations</h4>
                        <div class="code-box">
                            <pre>php artisan migrate</pre>
                        </div>

                        <h4>7. Start Development Server</h4>
                        <div class="code-box">
                            <pre>php artisan serve</pre>
                        </div>
                        ...
                        <h3>Using Docker (Laravel Sail)</h3>
                        <div class="code-box">
                            <pre>./vendor/bin/sail up
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td><strong>200</strong></td>
                                    <td>OK</td>
                                    <td>Successful GET, PUT, PATCH request</td>
                                </tr>
                                <tr>
                                    <td><strong>201</strong></td>
                                    <td>Created</td>
  ...
  "errors": {}
                    ...
                    <section id="data-models">
                        ...
                        <ul>
                            ...
                            <li><strong>Permission</strong> - System permissions</li>
                            <li><strong>Address</strong> - User delivery addresses</li>
                            <li><strong>ProductVariant</strong> - Product variations (size, color, etc.)</li>
                            <li><strong>OrderItem</strong> - Individual items in orders</li>
                            <li><strong>CartItem</strong> - Individual items in shopping carts</li>
                        </ul>
                    </section>
                    ...
                    <section id="development-guidelines">
                        ...
                        <h4>Type Hints</h4>
                        <p>Type hint all method parameters and return types:</p>
                        <div class="code-box">
                            <pre>public function getProduct(int $id): Product
{
    return Product::findOrFail($id);
                        ...
                        <h4>Form Requests</h4>
                        <p>Use Form Request classes for validation logic.</p>
...
./vendor/bin/phpunit</pre>
                        ...
                        <div class="code-box">
                            <pre>Create: php artisan make:migration create_table_name
Run: php artisan migrate
Rollback: php artisan migrate:rollback</pre>
                        </div>
                    ...
                    <section id="summary">
                        ...
                        <p>The E-Commerce Backend API provides a complete, scalable solution for managing e-commerce operations. Built with Laravel 12 and following industry best practices, it offers:</p>
